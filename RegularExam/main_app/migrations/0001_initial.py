# Generated by Django 5.0.4 on 2025-03-29 07:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('co_authors', models.ManyToManyField(related_name='co_actor_movies', to='main_app.author')),
                ('main_author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='main_author_book', to='main_app.author')),
                ('publisher', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='publisher_book', to='main_app.publisher')),
            ],
            options={
                'abstract': False,
            },
